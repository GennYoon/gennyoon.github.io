  ...
  return (
    <div className="relative group">
      <pre
        ref={preRef}
        {...props}
        className={twMerge(className, "focus:outline-none")}
      >
        <div className="absolute flex items-center space-x-2 top-0 right-0 m-2">
          <span
            className={cn("hidden fade-in text-xs text-green-400", {
          ...
          <button
            ...
            className={cn(
              "hidden transition bg-transparent border rounded-md p-2 focus:outline-none group-hover:flex fade-in",
              {
                ...
                "hover:border-gray-500 dark:border-gray-700 dark:hover:border-gray-400 focus:ring-4 focus:ring-gray-200 focus:ring-opacity-50":
                  !copied,
              }
            )}
          >
            <svg
              ...
              className={cn("h-4 w-4 pointer-events-none", {
